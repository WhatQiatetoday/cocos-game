    ...
    execute: function () {
      ...
      _export("NewComponent", NewComponent = (_dec = ccclass('NewComponent'), _dec2 = property({
        ...
        boom(pos, color) {
          ...
          var particle = this.boomNode.getComponent(ParticleSystem2D); // particle.stopSystem()

          if (color !== undefined) {
            particle.startColor = color;
          }

          particle.resetSystem(); // if(particle.stopped){
          //     particle.stopSystem()
          // }
        }
...
//# sourceMappingURL=4a4c103f67abe87cd375fae1cdeb50dc19c0c1da.js.map