System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, Input, input, Node, ParticleSystem, Sprite, tween, UITransform, v3, view, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, NewComponent;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Component', 'director', 'Input', 'input', 'Node', 'ParticleSystem', 'Sprite', 'Tween', 'tween', 'TweenAction', 'TweenSystem', 'UITransform', 'v3', 'view']);
      ...
      _export("NewComponent", NewComponent = (_dec = ccclass('NewComponent'), _dec2 = property({
        ...
        die() {
          console.log('游戏结束!!!'); // 重新加载游戏场景，游戏重新开始
        ...
        boom(pos, color) {
          ...
          var particle = this.boomNode.getComponent(ParticleSystem);
...
//# sourceMappingURL=f4893fd0196f8e7de9dc045f81c2c22a9e1430f6.js.map