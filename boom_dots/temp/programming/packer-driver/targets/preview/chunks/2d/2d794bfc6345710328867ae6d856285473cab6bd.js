System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Contact2DType, director, Input, input, Node, ParticleSystem2D, PhysicsSystem2D, Sprite, tween, UITransform, v3, view, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, NewComponent;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Canvas', 'Color', 'Component', 'Contact2DType', 'director', 'find', 'Input', 'input', 'Node', 'ParticleSystem', 'ParticleSystem2D', 'PhysicsSystem2D', 'Sprite', 'sys', 'Tween', 'tween', 'TweenAction', 'TweenSystem', 'UITransform', 'v3', 'Vec3', 'view']);
      ...
      _export("NewComponent", NewComponent = (_dec = ccclass('NewComponent'), _dec2 = property({
        ...
        start() {
          ...
          if (PhysicsSystem2D.instance) {
            PhysicsSystem2D.instance.on(Contact2DType.BEGIN_CONTACT, this.onBeginContact, this); // PhysicsSystem2D.instance.on(Contact2DType.END_CONTACT, this.onEndContact, this);
...
//# sourceMappingURL=2d794bfc6345710328867ae6d856285473cab6bd.js.map