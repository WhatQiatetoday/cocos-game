System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, find, Input, input, Node, ParticleSystem2D, Sprite, tween, UITransform, v3, view, _dec, _dec2, _dec3, _dec4, _class, _class2, _descriptor, _descriptor2, _descriptor3, _crd, ccclass, property, NewComponent;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Canvas', 'Color', 'Component', 'director', 'find', 'Input', 'input', 'Node', 'ParticleSystem', 'ParticleSystem2D', 'Sprite', 'sys', 'Tween', 'tween', 'TweenAction', 'TweenSystem', 'UITransform', 'v3', 'Vec3', 'view']);
      ...
      _export("NewComponent", NewComponent = (_dec = ccclass('NewComponent'), _dec2 = property({
        ...
        start() {
          this.placePlayer(); // this.placeEnemy()
...
//# sourceMappingURL=99c38782076f456fbf3c3ac535f3ce27fce00f6f.js.map