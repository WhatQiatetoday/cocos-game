System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, director, Input, input, Node, ParticleSystem2D, Sprite, tween, UITransform, v3, view, _dec, _dec2, _dec3, _class, _class2, _descriptor, _descriptor2, _crd, ccclass, property, NewComponent;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Color', 'Component', 'director', 'Input', 'input', 'Node', 'ParticleSystem', 'ParticleSystem2D', 'Sprite', 'Tween', 'tween', 'TweenAction', 'TweenSystem', 'UITransform', 'v3', 'Vec3', 'view']);
      ...
      _export("NewComponent", NewComponent = (_dec = ccclass('NewComponent'), _dec2 = property({
        ...
        die() {
          console.log('游戏结束!!!');
          this.playerNode.active = false; // 重新加载游戏场景，游戏重新开始
...
//# sourceMappingURL=5abfb900dcf9692ae7cef90693b4dcfa098b20fb.js.map