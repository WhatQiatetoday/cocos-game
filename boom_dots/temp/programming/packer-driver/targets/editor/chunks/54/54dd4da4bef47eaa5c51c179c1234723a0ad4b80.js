System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Contact2DType, director, Input, input, Label, Node, ParticleSystem2D, PhysicsSystem2D, RigidBody2D, tween, UITransform, v3, Vec2, view, _dec, _dec2, _dec3, _dec4, _dec5, _class, _class2, _descriptor, _descriptor2, _descriptor3, _descriptor4, _crd, ccclass, property, NewComponent;
  ...
  return {
    ...
    execute: function () {
      ...
      __checkObsolete__(['_decorator', 'Canvas', 'Collider2D', 'Color', 'Component', 'Contact2DType', 'director', 'find', 'Input', 'input', 'Label', 'Node', 'ParticleSystem', 'ParticleSystem2D', 'PhysicsSystem2D', 'RigidBody2D', 'Sprite', 'sys', 'Tween', 'tween', 'TweenAction', 'TweenSystem', 'UITransform', 'v2', 'v3', 'Vec2', 'Vec3', 'view']);
      ...
      _export("NewComponent", NewComponent = (_dec = ccclass('NewComponent'), _dec2 = property({
        ...
        update(deltaTime) {
          ...
          if (PhysicsSystem2D.instance) {
            PhysicsSystem2D.instance.on(Contact2DType.BEGIN_CONTACT, this.onBeginContact, this); // PhysicsSystem2D.instance.on(Contact2DType.PRE_SOLVE, this.onPreSolve, this);
          }
        }
        ...
        die() {
          console.log('游戏结束!!!');
          this.playerNode.active = false; // this.boom(this.playerNode.position,this.playerNode.getComponent(Sprite).color)
          // 延时1s后执行,且只执行一次
          // 重新加载游戏场景，游戏重新开始
        ...
        sleep(roleNode) {
          let rigidBody = roleNode.getComponent(RigidBody2D); // 设置刚体的线速度和角速度为0，使其进入睡眠状态
        ...
        onBeginContact() {
          console.log('开始碰撞');
          this.fireTo.stop(); // this.boom(this.enemyNode.position,this.enemyNode.getComponent(Sprite).color)
...
//# sourceMappingURL=54dd4da4bef47eaa5c51c179c1234723a0ad4b80.js.map