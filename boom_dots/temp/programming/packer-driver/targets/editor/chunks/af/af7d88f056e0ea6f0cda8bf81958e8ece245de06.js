    ...
    execute: function () {
      ...
      _export("NewComponent", NewComponent = (_dec = ccclass('NewComponent'), _dec2 = property({
        ...
        die() {
          ...
          this.scheduleOnce(() => {
            // 重新绑定需要保留的节点
            const newNode1 = this.boomNode.parent; // sys.localStorage.setItem("node",newNode1)

            console.log(newNode1);
            console.log("新绑定的节点");
            director.loadScene('game', (error, newNode1) => {
              // 进行节点绑定的判断和处理
              if (newNode1) {
        ...
        boom(pos, color) {
          ...
          this.boomNode.active = true; // particle.resetSystem()
...
//# sourceMappingURL=af7d88f056e0ea6f0cda8bf81958e8ece245de06.js.map