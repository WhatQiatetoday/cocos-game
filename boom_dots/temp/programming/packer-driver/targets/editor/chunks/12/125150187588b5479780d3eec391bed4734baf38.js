System.register(["cc"], function (_export, _context) {
  ...
  var _cclegacy, __checkObsolete__, __checkObsoleteInNamespace__, _decorator, Component, Node, view, _dec, _dec2, _class, _class2, _descriptor, _crd, ccclass, property, NewComponent;
  ...
  return {
    ...
    execute: function () {
      ...
      _export("NewComponent", NewComponent = (_dec = ccclass('NewComponent'), _dec2 = property({
        ...
        placePlayer() {
          let View = view.getVisibleSize();
          console.log(View); // this.playerNode.setPosition()
        }
...
//# sourceMappingURL=125150187588b5479780d3eec391bed4734baf38.js.map